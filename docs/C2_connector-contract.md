...
- `call_llm` 对接 OpenClaw 的模型调用能力
- `extract` 对接 Layer0 的输入提取能力
- `harness_clean`、`harness_preserve`、`harness_decay` 对接平台侧的维护与 session watch 逻辑
